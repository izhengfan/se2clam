...
//    }
    ...
    // traj log
    ofstream fileOutTraj(se2clam::Config::WRITE_TRAJ_FILE_PATH + se2clam::Config::WRITE_TRAJ_FILE_NAME);
    // traj log
...
void Localizer::WriteTrajFile(ofstream & file) {
    ...
    Mat wTb = scv::inv(se2clam::Config::bTc * mpKFCurrRefined->getPose());
...
void Localizer::UpdatePoseCurr() {
    Se2 dOdo = mpKFRef->mOdo - mpKFCurr->mOdo;
