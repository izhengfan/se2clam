...
//    // Draw MPs on current image
//    int numFeatCurrent = viMatch.size();

//    for (int idxFeatCurrent=0; idxFeatCurrent<numFeatCurrent; idxFeatCurrent++) {

//        int idxFeatLoop = viMatch[idxFeatCurrent];

//        KeyPoint kpCurrent = mpKFCurr->keyPoints[idxFeatCurrent];
//        Point2f ptCurrent = kpCurrent.pt;

//        Scalar color;
//        if (mpKFCurr->hasObservation(idxFeatCurrent)) {
...
//        if (idxFeatLoop == -1) {
//            circle(mImgMatch, ptCurrent, 3, color, 1);
//        }
//        else {
//            KeyPoint kpLoop = mpKFLoop->keyPoints[idxFeatLoop];
//            Point2f ptLoop = kpLoop.pt;
//            Point2f ptLoopMatch = ptLoop;
//            ptLoopMatch.y += 480;
//            circle(mImgMatch, ptCurrent, 3, color, 1);
//            circle(mImgMatch, ptLoopMatch, 3, color, 1);
//            line(mImgMatch, ptCurrent, ptLoopMatch, color);
//        }
//    }
//}
